...
class UserLivestockTrackerOwnerController extends Controller
{
    //
    public function index(Request $request): View {
        ...
        return view('user.managed.livestock.ownertracker', ['farmers' => $livestock->latest()->paginate(25), 'Farmers' => PersonalInformation::get(), 'search' => $request->search]);
    }
    ...
    public function livestockChangeOwner(Request $request): RedirectResponse {
        ...
        return redirect()->route('userLivestockOwnerTracker.index')->with('success', 'Livestock Owner Successfully Changed');
    }
}
