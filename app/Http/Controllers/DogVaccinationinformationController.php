...
class DogVaccinationinformationController extends Controller
{
    ...
    public function index(Request $request): View {
        ...
        return view('user.vaccination.index', ['DogInformations' => $dogs->latest()->paginate(100), 'search' => $request->search]);
    }

    public function create(): View {
        return view('user.vaccination.create', ['personalInformation' => PersonalInformation::where('is_approved', true)->whereNotNull('RSBSA_No')->get()]);
    }
    ...
    public function store(Request $request): RedirectResponse {
        ...
        activity('Activity Logs')->causedBy(Auth::user())->performedOn($new_dog)->createdAt(now())->log('- Added a new record.');
    ...
    public function edit(DogInformation $dogInformation): View {
        return view('user.vaccination.edit', ['DogInformation' => $dogInformation, 'personalInformation' => PersonalInformation::latest()->whereNotNull('RSBSA_No')->get()]);
    }
