                ...
                <tr class="grid grid-cols-1 py-2 bg-green-700 text-white w-full">
                    ...
                    <tr class="grid py-1 odd:bg-slate-200 grid-cols-7 w-full">
                        ...
                        <td class="flex items-center justify-center gap-x-3">
                            <form action="{{route('adminPersonalInformation.acceptUpdate', ['personalInformation' => $PersonalInformation])}}" method="post">
                                @csrf
                                @method('put')
                                <div class="w-full">
                                    <button type="submit">
                            ...
                            <form class="" action="" method="post">
                                ...
                                <div class="w-full">
                                    ...
                                    <button type="submit">
                                        <img class="max-w-[34px] p-1 hover:bg-green-300/50 rounded-full" src="{{asset('images/icons/reject.png')}}" alt="">
                                    </button>
                                </div>
                            </form>
                        </td>		
