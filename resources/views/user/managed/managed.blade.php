<x-app>
    ...
    <section class="w-full min-h-screen p-5 overflow-y-auto">
        <section class="flex flex-col my-2 items-start justify-center gap-y-6">
            <h2 class="text-2xl sm:text-4xl mx-2 text-slate-700 font-bold text-black">Managed Farmers</h2>
                    ...
                    @foreach ($PersonalInformations as $PersonalInformation)
                        <tr class="pt-10">
                            ...
                            <td class="flex items-center justify-center">
                                <a href="{{route('user.managedFarmersDetails', ['personalInformation' => $PersonalInformation, 'currentRoute' => 'personal'])}}">
